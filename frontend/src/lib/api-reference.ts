...
export const API_REFERENCE: ApiCategory[] = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "POST", path: "/api/image/resize", summary: "Resize image(s).", result: "file", fields: [FILES("One or more images."), { name: "width", required: false, type: "integer", default: "1280", description: "Target width (px)." }, { name: "height", required: false, type: "integer", default: "720", description: "Target height (px)." }, { name: "keep_ratio", required: false, type: "boolean", default: "true", description: "true = fit within W×H keeping aspect; false = exact W×H." }] },
