...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    category: "ai",
    description: "Remove the background from any photo and get a clean transparent PNG.",
    longDescription:
      "AI Background Remover detects the main subject and erases everything behind it automatically — no manual masking. Download a transparent PNG, or drop your subject onto a solid white, black or studio colour. Perfect for product shots, profile pictures and design assets.",
    icon: Eraser,
    accept: IMG,
    multiple: false,
    ...
    options: [
      {
        ...
        default: "general",
        options: [
          { label: "General (auto)", value: "general" },
          { label: "Person / portrait", value: "portrait" },
          { label: "Fast (lower detail)", value: "fast" },
        ],
      },
      {
        type: "select",
        ...
        options: [
          ...
          { label: "Studio green", value: "green" },
          { label: "Studio blue", value: "blue" },
        ],
      },
      { type: "toggle", name: "edges", label: "Refine edges (slower, sharper)", default: false },
    ],
    seo: {
      title: "AI Background Remover — Remove Image Background Online Free",
      description:
        "Remove the background from photos automatically with AI. Get a transparent PNG in seconds — free, no signup, no watermark.",
      keywords: [
        "background remover",
        "remove background",
        "transparent png",
  ...
  },
  {
    ...
    category: "ai",
    description: "Upscale and enhance low-resolution images up to 4× with sharper detail.",
    longDescription:
      "AI Image Upscaler enlarges small or blurry pictures 2×–4× while sharpening detail, reducing noise and boosting clarity. Great for rescuing low-res photos, product images and old downloads without the jagged edges of a normal resize.",
    icon: Wand2,
    accept: IMG,
    multiple: false,
    ...
    options: [
      {
        ...
        options: [
          ...
          { label: "4× (maximum)", value: "4" },
        ],
      },
      { type: "toggle", name: "sharpen", label: "Sharpen detail", default: true },
      { type: "toggle", name: "denoise", label: "Reduce noise (slower)", default: false },
    ],
    seo: {
      title: "AI Image Upscaler — Enlarge & Enhance Photos Online Free",
      description:
        "Upscale images up to 4× and enhance detail with AI. Fix low-resolution and blurry photos online for free. Fast and secure.",
      keywords: [
        "image upscaler",
        "ai upscaler",
        "enhance image",
  ...
  {
    slug: "photo-restore",
    title: "AI Photo Restorer & Colorizer",
    category: "ai",
    description: "Restore old photos and add natural color to black-and-white pictures.",
    longDescription:
      "AI Photo Restorer cleans up noise, sharpens faded detail and balances contrast in old or damaged photos. Turn on colorization to bring black-and-white memories to life with natural, AI-predicted colour.",
    icon: Palette,
    accept: IMG,
    multiple: false,
    endpoint: "/api/ai/restore",
    actionLabel: "Restore Photo",
    resultType: "file",
    options: [
      { type: "toggle", name: "colorize", label: "Colorize black & white", default: false },
      { type: "toggle", name: "enhance", label: "Enhance & denoise", default: true },
    ],
    seo: {
      title: "AI Photo Restorer & Colorizer — Restore Old Photos Online Free",
      description:
        "Restore old, damaged or black-and-white photos with AI. Remove noise, sharpen detail and add natural colour online for free.",
      keywords: [
        "photo restoration",
        "restore old photos",
  ...
  {
    slug: "image-caption",
    title: "AI Image Caption & Alt-Text",
    category: "ai",
    description: "Generate accurate alt-text, descriptions or SEO tags for any image.",
    longDescription:
      "AI Image Caption looks at your image and writes accessibility-ready alt-text, a rich description, or a list of SEO keyword tags — in your chosen language. Ideal for making sites accessible and improving image search ranking.",
    icon: Captions,
    accept: IMG,
    multiple: false,
    ...
    options: [
      {
        ...
        default: "alt",
        options: [
          { label: "Alt text (accessibility)", value: "alt" },
          { label: "Detailed description", value: "detailed" },
          { label: "SEO keywords / tags", value: "keywords" },
        ],
      },
      {
        type: "select",
    ...
    seo: {
      title: "AI Image Caption & Alt-Text Generator — Free Online",
      description:
        "Generate alt-text, image descriptions and SEO tags automatically with AI. Improve accessibility and image SEO online for free.",
      keywords: [
        "alt text generator",
  ...
  {
    slug: "pdf-to-audio",
    title: "PDF to Audio (Text to Speech)",
    category: "ai",
    description: "Turn PDF, Word or text documents into natural-sounding MP3 audio.",
    longDescription:
      "PDF to Audio reads your document aloud with lifelike neural voices and saves it as an MP3 you can listen to anywhere. Choose from multiple voices and languages and adjust the speaking speed — perfect for turning reports, articles and notes into a personal audiobook.",
    icon: Headphones,
    accept: DOC_TEXT,
    multiple: false,
    endpoint: "/api/ai/text-to-speech",
    actionLabel: "Convert to Audio",
    resultType: "file",
    featured: true,
    options: [
      {
        ...
        options: [
          ...
          { label: "Spanish — Elvira ♀", value: "es-ES-ElviraNeural" },
          { label: "French — Denise ♀", value: "fr-FR-DeniseNeural" },
          { label: "German — Katja ♀", value: "de-DE-KatjaNeural" },
          { label: "Hindi — Swara ♀", value: "hi-IN-SwaraNeural" },
        ],
      },
      {
        type: "select",
    ...
    seo: {
      title: "PDF to Audio — Convert PDF & Text to Speech (MP3) Online Free",
      description:
        "Convert PDF, Word and text documents to natural-sounding MP3 audio with AI voices. Free text-to-speech and audiobook maker online.",
      keywords: [
        "pdf to audio",
        "text to speech",
        "pdf to mp3",
  ...
  {
    slug: "audio-to-text",
    title: "AI Audio & Video Transcription",
    category: "ai",
    description: "Transcribe speech from audio or video files into accurate text.",
    longDescription:
      "AI Audio & Video Transcription converts speech in any audio or video file into clean, readable text using OpenAI Whisper. It auto-detects the language and can even translate foreign speech into English — great for interviews, lectures, podcasts and meetings.",
    icon: Mic,
    accept: AV,
    multiple: false,
    ...
    options: [
      ...
      { type: "toggle", name: "translate", label: "Translate to English", default: false },
    ],
    seo: {
      title: "AI Transcription — Audio & Video to Text Online Free",
      description:
        "Transcribe audio and video to text with AI (Whisper). Auto language detection and translation to English. Free, fast and accurate.",
      keywords: [
        "audio to text",
        "transcribe audio",
        "video to text",
  ...
  },
  {
    ...
    category: "ai",
    description: "Generate SRT or VTT subtitles from any video or audio automatically.",
    longDescription:
      "AI Subtitle Generator listens to your video or audio and produces perfectly timed subtitles as an SRT or VTT file. It auto-detects the language and can translate to English — ready to upload to YouTube or load into any video editor.",
    icon: Captions,
    accept: AV,
    multiple: false,
    endpoint: "/api/ai/subtitles",
    ...
    seo: {
      title: "AI Subtitle Generator — Create SRT & VTT Subtitles Online Free",
      description:
        "Generate accurate, perfectly timed subtitles (SRT/VTT) from video or audio with AI. Auto language detection and translation. Free online.",
      keywords: [
        "subtitle generator",
        "generate subtitles",
        "video to srt",
  ...
  },
  {
    ...
    category: "ai",
    description: "Translate PDF, Word and text documents into 20+ languages.",
    longDescription:
      "AI Document Translator extracts the text from your PDF, Word or TXT file and translates it into the language you choose, then hands back a ready-to-edit Word document. Powered by AI for natural, fluent results across 20+ languages.",
    icon: Languages,
    accept: DOC_TEXT,
    multiple: false,
    ...
    seo: {
      title: "AI Document Translator — Translate PDF & Word Online Free",
      description:
        "Translate PDF, Word and text documents into 20+ languages with AI. Download a ready-to-edit translated document. Free and secure.",
      keywords: [
        "document translator",
        "translate pdf",
