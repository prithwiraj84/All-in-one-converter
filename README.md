...
<a href="#">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:7C3AED,50:2563EB,100:06B6D4&height=220&section=header&text=All-in-One%20Converter&fontSize=52&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=All%20Your%20File%20Tools.%20One%20Powerful%20Platform.&descSize=18&descAlignY=60" alt="All-in-One Converter" width="100%" />
</a>

<!-- Animated typing tagline -->
<a href="#">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=3000&pause=900&color=7C3AED&center=true&vCenter=true&width=640&height=48&lines=Convert+%E2%80%A2+Compress+%E2%80%A2+Edit+%E2%80%A2+Optimize;100%2B+Tools+Across+9+Categories;PDF+%C2%B7+Docs+%C2%B7+Images+%C2%B7+Audio+%C2%B7+Video+%C2%B7+Fonts;A+Modern+Alternative+to+iLovePDF+%26+CloudConvert" alt="Typing tagline" />
</a>
...
<p>
  ...
  <img src="https://img.shields.io/badge/FastAPI-Python%203.12-009688?style=for-the-badge&logo=fastapi&logoColor=white" alt="FastAPI" />
...
<!-- Repo stats -->
<p>
  <a href="https://github.com/prithwiraj84/All-in-one-Converter/stargazers"><img src="https://img.shields.io/github/stars/prithwiraj84/All-in-one-Converter?style=for-the-badge&color=7C3AED&logo=github&logoColor=white" alt="Stars" /></a>
  <a href="https://github.com/prithwiraj84/All-in-one-Converter/network/members"><img src="https://img.shields.io/github/forks/prithwiraj84/All-in-one-Converter?style=for-the-badge&color=2563EB&logo=github&logoColor=white" alt="Forks" /></a>
  <a href="https://github.com/prithwiraj84/All-in-one-Converter/issues"><img src="https://img.shields.io/github/issues/prithwiraj84/All-in-one-Converter?style=for-the-badge&color=06B6D4&logo=github&logoColor=white" alt="Issues" /></a>
  <a href="https://github.com/prithwiraj84/All-in-one-Converter/commits"><img src="https://img.shields.io/github/last-commit/prithwiraj84/All-in-one-Converter?style=for-the-badge&color=22C55E&logo=git&logoColor=white" alt="Last commit" /></a>
...
<div align="center">
  <img src="https://skillicons.dev/icons?i=nextjs,react,ts,tailwind,fastapi,python,supabase,docker,vercel&perline=9" alt="Tech stack icons" />
</div>
...
flowchart LR
    ...
    subgraph FE["▲ Next.js 15 · Frontend"]
        direction TB
        UI[Animated UI<br/>shadcn/ui · Framer Motion]
        REG[(Tools Registry<br/>single source of truth)]
        UI --- REG
    end
    ...
    subgraph BE["⚙️ FastAPI · Backend"]
        ...
        SEC[Security<br/>rate-limit · validation]
        SVC[Processing Services]
        API --- SEC --- SVC
    end

    subgraph WK["🛠️ System Engines"]
        direction TB
        E1[pypdf / PyMuPDF]
        E2[Pillow]
        E3[Tesseract OCR]
    ...
    DB[(🟢 Supabase<br/>Auth · Postgres · Storage)]:::db

    U -->|Upload| UI
    UI -->|REST · TanStack Query| API
    SVC --> WK
    UI <-->|OAuth + Session| DB
    SVC -->|Store + auto-delete 60m| DB
    SVC -->|Download| U

    classDef user fill:#7C3AED,stroke:#fff,color:#fff;
    classDef db fill:#3FCF8E,stroke:#fff,color:#053;
    style FE fill:#0b1020,stroke:#2563EB,color:#fff
    style BE fill:#0b1020,stroke:#06B6D4,color:#fff
    style WK fill:#0b1020,stroke:#7C3AED,color:#fff
```
...
```mermaid
flowchart LR
    A[📤 Upload<br/>drag & drop]:::s --> B[⚙️ Process<br/>choose options]:::s --> C[📥 Download<br/>instant result]:::s --> D[🗑️ Auto-Delete<br/>within 60 min]:::s
    classDef s fill:#111827,stroke:#7C3AED,color:#fff;
```
...
![FFmpeg](https://img.shields.io/badge/FFmpeg-optional-007808?style=flat-square&logo=ffmpeg&logoColor=white)
![Tesseract](https://img.shields.io/badge/Tesseract-optional-5C3EE8?style=flat-square)
![LibreOffice](https://img.shields.io/badge/LibreOffice-optional-18A303?style=flat-square&logo=libreoffice&logoColor=white)
...
```mermaid
flowchart LR
    A[➕ Add entry to<br/>tools-registry.ts]:::a --> B[🧭 Nav · /tools · Showcase]:::b
    A --> C[🔎 SEO page at /slug]:::b
    A --> D[🧪 Interactive workspace]:::b
    A --> E[🔌 Add backend<br/>endpoint + service]:::c
    classDef a fill:#7C3AED,stroke:#fff,color:#fff;
    classDef b fill:#2563EB,stroke:#fff,color:#fff;
    classDef c fill:#06B6D4,stroke:#fff,color:#053;
```
...
#   A l l - i n - o n e - c o n v e r t e r  
 